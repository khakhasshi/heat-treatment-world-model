...
\end{center}
仓库包含有限差分与 BDF 求解器、世界模型训练和评价程序、边界观测器、EnKF 状态估计、滚动时域控制、绘图脚本、轻量实验结果及两套论文源文件。公开版本以标签 \texttt{thesis-open-release-v1} 标识。模型权重由 Hugging Face 单独托管，其文件映射与 SHA-256 校验值记录在仓库的 \path{docs/huggingface-weights-manifest.csv}。该组织方式使代码版本、论文取数和二进制检查点能够逐项核对。
