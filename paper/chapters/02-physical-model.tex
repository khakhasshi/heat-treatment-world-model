...
高温物性采用公开 AISI 1045 数据表的分段线性插值\cite{sanchez2023splat}。Carollo 等的低温实验反演结果用于核对低温段变化趋势\cite{carollo2019properties}。表\ref{tab:properties}列出计算所用节点值。原始数据在 \SI{600}{\degreeCelsius} 至 \SI{800}{\degreeCelsius} 间给出明显的比热变化，本文按表值插值，并将其视为给定的等效热容曲线。该曲线没有进一步分解显热和相变潜热，所以本研究不据此解释组织转变。
